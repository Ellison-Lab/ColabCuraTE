>##### File descriptions
>- The initial, pre-curation, consensus sequence is in the file labeled `*_con.fa`. This file should be used as the starting point for the manual curation process.
...
#### Important
For Step 2.1 in the notebook: Please use the file `sine_con.fa` as the input repeat library FASTA file for this example and use `rnd-2_family-242` for the SeqID field.
